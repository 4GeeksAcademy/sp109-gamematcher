...
const Login = () => {
  ...
  return (
    <div className="auth-wrapper">
      <div className="auth-figures d-none d-lg-block" aria-hidden="true">
        <figure className="w-100 m-0">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1506.3 578.7" className="auth-figures-svg">
      ...
      <div className="container px-4 px-lg-0 pb-5">
        <div className="row justify-content-center justify-content-lg-between g-3 g-xl-4 mt-0">
          ...
          <div className="col-sm-10 col-lg-5 col-xl-5 order-lg-2 ps-lg-5 ms-lg-3">
            <div className="auth-card p-4 p-md-5">

              <div className="mb-3">
                {mode === "login" ? (
                  <>
                    <h6 className="h3 text-start">Login</h6>
                    <p className="text-muted auth-subtitle">Sign in to your account to continue.</p>
                  </>
                ) : (
                  <>
                    <h6 className="h3 text-start">Create account</h6>
                    <p className="text-muted auth-subtitle">Made with love by developers for developers.</p>
                  </>
                )}
              </div>
              ...
              <form onSubmit={mode === "login" ? handleLogin : handleSignup}>
                ...
                <div className="mb-3">
                  <div className="d-flex align-items-center justify-content-between mb-1">
                    ...
                    {mode === "login" && (
                      <a
                        href="#"
                        className="small text-underline--dashed border-primary text-muted"
                      >
                        Lost password?
                      </a>
                    )}
                  ...
                  <div className="input-group input-group-merge">
                    ...
                    <input
                      ...
                      className="form-control"
                      placeholder={mode === "login" ? "Tu contraseña" : "Create a password"}
                      value={password}
                ...
                <button type="submit" className="btn-auth" disabled={loading}>
                  {loading ? (mode === "login" ? "Iniciando..." : "Registrando...") : <>
                    {mode === "login" ? "Sign in" : "Create my account"} <i className="fa-solid fa-arrow-right ms-1" />
                  </>}
                </button>
