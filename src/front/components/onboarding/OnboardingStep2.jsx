                    ...
                    <div className="card-body p-5">
                        ...
                        <div className="text-center mb-4">
                            ...
                            <p className="text-muted">
                                Selecciona los géneros de juegos que más disfrutas. 
                        ...
                        <div className="row g-3 mb-4">
                            {genres.map((genre, index) => (
                                <div key={genre.id} className="col-md-4 col-lg-3">
                                    <div
                                        className={`card h-100 border-2 cursor-pointer genre-card ${
                                            selectedGenres.includes(genre.id)
                                                ? `border-${getGenreColor(index)} bg-${getGenreColor(index)} text-white`
                                                : 'border-light'
                                        }`}
                                    ...
                                    >
                                        <div className="card-body text-center p-3">
                                            <i className={`${getGenreIcon(genre.name)} fa-2x mb-2`}></i>
